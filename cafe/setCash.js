...
function footer() {
    ...
    element.innerHTML = `<p>Made by gliz <br> My <a style="color: #0000ff;" href="https://twitter.com/glizuwu" target="_blank">twitter</a></p>`;    element.innerHTML = `<p>Started by gliz <br> My <a style="color: #0000ff;" href="https://twitter.com/glizuwu" target="_blank">twitter</a> <br> Perfected by RHW <br> My <a style="color: #0000ff;" href="https://infintium.xyz" target="_blank">website</a></p>`;    document.body.appendChild(element);
